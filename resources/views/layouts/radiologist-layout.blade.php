...
<body>
    <div>
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href={{ route('radiologist.index') }}>
                ...
                <div class="collapse navbar-collapse d-lg-flex justify-content-lg-end" id="navbarNavDropdown">
                    <ul class="navbar-nav gap-4">
                        <li class="nav-item">
                            <a class="nav-link" href={{ route('radiologist.assignment.index') }}>Assignments</a>
                        </li>
                        <li class="nav-item">
                            <form action="{{ route('radiologist.logout') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <a class="nav-link" href="{{ route('radiologist.logout') }}"
